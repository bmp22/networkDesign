...
expect_equal(gridSearch(JRSSExamples$ex1,2,weightPrior = c(20,10,0,0.5))$AOptVal,1.10239e-05,tolerance=1e-10)
  expect_equal(gridSearch(JRSSExamples$ex1,2,weightPrior = c(20,10,0,0.5), viralOpt=FALSE)$AOptVal,0.4000108,tolerance=1e-7)
})
