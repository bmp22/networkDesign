...
The aim of the vignette is really to provide the means for users to reproduce the results in that paper, and extend them to their own work. This vignette, and indeed the whole package, is very much a draft, and suggestions for changes/improvements are welcomed.
...
![A crossover trual](/home/bmp22/Dropbox/Talks/figures/example6nakedv3.png){#id .class width=250px}
